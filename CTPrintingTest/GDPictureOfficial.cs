            ...
            using (GdPicturePDF pdf = new GdPicturePDF())
            {
                ...
                if (pdf.LoadFromFile(fileSelected, false) == GdPictureStatus.OK)
                {
                    ...
                    if (pdf.PrintDialog())
                    {
                        ...
                        txtOutput = txtOutput + "The file has been printed successfully. Loaded " + elapsedLoad + "s, Printed " + elapsedPrint + "s.";
                    }
                    else
                    {
                        ...
                        if (pdf.PrintGetStat() == GdPictureStatus.PrintingException)
                            txtOutput = txtOutput + "    Error: " + pdf.PrintGetLastError();
                    }
                }
                else
                {
                    txtOutput = txtOutput + "The file can't be loaded. Status: " + pdf.GetStat().ToString();
                }
            }
